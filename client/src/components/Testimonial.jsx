...
const Testimonial = () => {
  ...
  const CreateCard = ({ card }) => (
    <div className="p-4 rounded-lg mx-4 shadow-lg transition-all duration-200 w-72 shrink-0  backdrop-blur-sm">
      <div className="flex gap-2">
        <img className="w-11 h-11 rounded-full border border-gray-700" src={card.image} alt="User" />
      ...
      <p className="text-sm py-4 text-gray-200">
  ...
  return (
    <div className="mt-5 h-[500px] w-full relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto py-16">
        ...
        <div className="marquee-row w-full overflow-hidden relative mb-10">
          ...
          <div className="marquee-inner flex min-w-[200%] gap-4">
        ...
        <div className="marquee-row w-full overflow-hidden relative">
          <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-black to-transparent" />
          <div className="marquee-inner marquee-reverse flex min-w-[200%] gap-4">
            {[...cardsData, ...cardsData].map((card, index) => (
              <CreateCard key={index} card={card} />
            ))}
          </div>
