...
/>
       {/* // <p className='mt-4 text-base font-medium'>Category</p>
        ...
        <textarea onChange={(e) => setinput(e.target.value)} rows={4} value={object} type="text" className='w-full p-2 px-4 mt-2 outline-none text-base rounded-md border border-gray-400' placeholder='e.g., watch or spoon, or only single object name' required />
        <button className='w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#417DF6] to-[#8E37EB] text-white px-4 py-3 mt-5 text-base rounded-lg cursor-pointer'>
